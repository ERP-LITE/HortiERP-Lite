...
<template>
  <th class="px-4 py-3 text-xs font-medium uppercase text-gray-500 dark:text-gray-400" :class="props.align === 'right' ? 'text-right' : 'text-left'">
    <button
      type="button"
      class="inline-flex items-center gap-1 hover:text-gray-900 focus:outline-none focus-visible:text-primary-700 dark:hover:text-gray-100 dark:focus-visible:text-primary-400"
